...
////////////////////////// GENERAR LAS PRODUCT CARDS //////////////////////////
    ...
    for (i = 0; i < categorias.length; i++) {
        div_categori += ` <button id="${categorias[i]}" class="boton-elegante" onclick="goresultados_cat('${criterio_cat}','${categorias[i]}')">${categorias[i]}</button>`;
    }
